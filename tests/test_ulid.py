...
from cmem_plugin_ulid.transform import Lifetime
from cmem_plugin_ulid.workflow import DollyPlugin
from tests.utils import TestExecutionContext, needs_cmem

PROJECT_NAME = "ulid_test_project"
...
def setup(request):
    ...
    with io.StringIO("ulid plugin sample file.") as response_file:
        create_resource(
            project_name=PROJECT_NAME,
